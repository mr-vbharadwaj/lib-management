...
def addBook(): 
    ...
    global bookInfo1,bookInfo2,bookInfo3,bookInfo4,Canvas1,con,cur,bookTable,Varun
    ...
    SubmitBtn = Button(Varun,text="SUBMIT",bg='#d1ccc0', fg='black',command=bookRegister)
